    ...
    attach: function attach(context, settings) {
      ...
      $form.on('submit', function(event) {
        ...
        if ($releaseDateField.length) {
          ...
          console.log('releaseDate', new Date($releaseDateField.val()));
          const releaseDate = Date.parse($releaseDateField.val());
          console.log('releaseDate parsed', releaseDate);
