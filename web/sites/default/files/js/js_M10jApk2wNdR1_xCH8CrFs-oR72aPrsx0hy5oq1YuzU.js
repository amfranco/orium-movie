      ...
      $form.on('submit', function(event) {
        ...
        if ($releaseDateField.length) {
          ...
          if (releaseDate > today) {
            ...
            $releaseDateField.after('<span class="release-date-error-message">' + Drupal.t('Release date can not be in the future.') + '</span>');
          }
          else {
            console.log('tudo bem');
            $releaseDateField.removeClass('error');
            $releaseDateField.find('.release-date-error-message').remove();
          }
        }
      });
    }
