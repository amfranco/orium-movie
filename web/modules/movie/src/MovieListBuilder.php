...
class MovieListBuilder extends EntityListBuilder {
  ...
  public function buildRow(EntityInterface $entity) {
    /* @var $entity \Drupal\movie\MovieInterface */
    $row['id'] = $entity->id();
    $row['title'] = $entity->toLink();
    $row['release_date'] = $this->dateFormatter->format($entity->getReleaseDate(), 'custom', 'Y-m-d');
    $row['genre'] = !$entity->field_genre->isEmpty() ? $entity->field_genre->first()->entity->getName() : '';
